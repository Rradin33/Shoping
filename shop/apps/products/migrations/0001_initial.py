    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateTimeField(auto_now=True, verbose_name='تاریخ اخرین به روز رسانی')),
                ('slug', models.SlugField(max_length=200, null=True)),
                ('group_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='products.productsgroup', verbose_name='والد گروه کالا')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='product_group',
            field=models.ManyToManyField(related_name='proucts_of_groups', to='products.productsgroup', verbose_name='گروه کالا'),
        ),
        migrations.AddField(
            model_name='feature',
            name='Product_Group',
            field=models.ManyToManyField(related_name='features_of_groups', to='products.productsgroup', verbose_name='گروه کالا'),
        ),
    ]
